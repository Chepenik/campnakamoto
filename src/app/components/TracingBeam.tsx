...
export const TracingBeam = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("relative w-full h-full py-20", className)}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="absolute -left-4 md:-left-6 lg:-left-10 top-0">
          <motion.div
            transition={{
              duration: 0.2,
              delay: 0.5,
          ...
          >
            ...
            <defs>
              <motion.linearGradient
                ...
                y2={y2}
              >
                <stop stopColor="#FF8225" stopOpacity="0"></stop>
                <stop stopColor="#FF8225"></stop>
                <stop offset="0.325" stopColor="#B43F3F"></stop>
                <stop offset="1" stopColor="#173B45" stopOpacity="0"></stop>
              </motion.linearGradient>
            </defs>
          </svg>
        </div>
